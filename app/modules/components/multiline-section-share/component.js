...
export default Component.extend({
	tagName: 'div',
	classNames: ['multi-lines-section', 'col-md-12', 'col-sm-12', 'col-xs-12'],
	...
	drawMultiLineChoose() {
		d3.select('svg.section-lines').remove();
		d3.select('.multi-lines-section .legendSectionContainer').remove();
		let svgContainer = d3.select(this.element);
		let svg = svgContainer.append("svg").attr('class', 'section-lines');
		...
		lines.selectAll('.line-group')
			...
			.on("mouseover", function(d) {
				d3.selectAll('.section-lines .line')
					.style('opacity', otherLinesOpacityHover);
				d3.selectAll('.section-lines .circle')
